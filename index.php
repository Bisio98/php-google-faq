...
<body>
    ...
    <header>
        <div class="top">
            <p></p>
            <div class="left">
                <img src="https://www.google.ch/images/branding/googlelogo/2x/googlelogo_color_160x56dp.png" alt="Google Logo">
                <h2>Privacy e Termini</h2>
            </div>
            <div class="right">
                <i class="fas fa-ellipsis-v"></i>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/User_icon_2.svg/640px-User_icon_2.svg.png" alt="User Pic">
            </div>
        </div>
        <div class="bottom">
            <ul>
    ...
    <main>
        <div class="container">
            <?php foreach($questions as $singleQuestion){?>
                <?php foreach($singleQuestion as $text){?>
                    <?php echo $text; ?>
                <?php } ?>
            <?php } ?>
        </div>
